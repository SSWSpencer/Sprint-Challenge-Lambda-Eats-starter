...
useRouteMatch gives a programmer access to the match property without rendering a <Route> component. It matchest the url just like a route would and it accepts and exact path

2. How would you explain form validation to someone who has never programmed before?
Form validation is used to validate a form's data to see if it contains the necessary information required.

3. In 1-2 sentences, define end to end testing. 
End to end testing is a technique used to test whether the flow of an application is behaving as expected. It is used to ensure that data is maintained between various system components.
